...
function replaceStr(txt) {
	...
	.replace(/ (유능|무능|무능력|촉촉|익숙|순|편안|편리|간편|중요|필요|불편|편|동일|암울|우울|귀중|소중|모호|애매|애매모호|유명|저명|다양|잔인|강인|상이|편협|협소|광대|광활|불과|간결|가능|불가|불가능|흔|가득|독특|특별|적합|부적합|적절|부적절|유사|유연|뻣뻣|행복|비슷)합니다(\.|<)/g,  ' $1하다$2')
